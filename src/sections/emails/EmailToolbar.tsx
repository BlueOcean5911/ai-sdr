...
const EmailToolbar = () => {
  ...
  return (
    <div className="w-full flex items-center gap-2 border-b border-gray-100 text-sm overflow-auto">
      ...
      <div className="w-28 min-w-20 py-1 flex flex-col text-xs text-center cursor-pointer text-blue-600 border-b bg-gray-100 border-b-blue-600">
        <span className="text-inherit">17</span>
        <span className="text-inherit">Total</span>
      </div>
      <div className="w-28 min-w-20 py-1 flex flex-col text-xs text-center cursor-pointer border-b hover:bg-gray-100 hover:border-b-blue-600">
