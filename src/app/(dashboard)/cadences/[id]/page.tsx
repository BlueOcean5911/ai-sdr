      ...
      <div className="flex flex-1 flex-col overflow-auto">
        ...
        <div className="w-full h-8 px-5 flex items-center gap-2">
          <span className="flex flex-col rounded-md text-sm hover:bg-gray-100">
            <span className="p-1.5 cursor-pointer font-semibold">Overview</span>
          ...
          <span className="flex flex-col rounded-md text-sm hover:bg-gray-100">
            <span className="p-1.5 cursor-pointer">Activity</span>
            <span className="w-full"></span>
          </span>
          <span className="flex flex-col rounded-md text-sm hover:bg-gray-100">
            <span className="p-1.5 cursor-pointer">Report</span>
            <span className="w-full"></span>
          </span>
          <span className="flex flex-col rounded-md text-sm hover:bg-gray-100">
