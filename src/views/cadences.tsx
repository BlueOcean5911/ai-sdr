                        ...
                        <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-3 rounded-r-md">
                          <Popover>
                            ...
                            >
                              <div className="p-3">
                                <div
                                  className="rounded-md p-1 font-semibold text-gray-900 cursor-pointer hover:bg-gray-100"
                                  onClick={() =>
                                    handleStatusChange(cadence.id, 0)
                                  }
                                >
                                  Active
                                </div>
                                <div
                                  ...
                                  onClick={() =>
                                    handleStatusChange(cadence.id, 1)
                                  }
                                >
                                  Disable
                                </div>
                                ...
                                <div
                                  className="rounded-md p-1 px-2 font-semibold text-gray-900 cursor-pointer hover:bg-gray-100"
                                  onClick={() =>
                                    handleDeleteCadence(cadence.id)
                                  }
                                >
                                  Delete
                                </div>
