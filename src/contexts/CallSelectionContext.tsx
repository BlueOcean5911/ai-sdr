...
const defaultCalls = [
  ...
  },
  {
    ...
    employees: 300,
    industry: "Consulting",
    keywords: ["callership", "strategy", "consulting"],
  },
  {
    id: 7,
    name: "Grace Lee",
...
export const CallSelectionContext = createContext<any>(undefined);
...
export const CallSelectionProvider = ({
  ...
  const [totalCalls, setTotalCalls] = useState<any[]>(defaultCalls);
